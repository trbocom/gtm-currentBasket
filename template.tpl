...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "trbo Current Basket",
  ...
  "description": "Das Current Basket Tracking stellt seitenweit die Informationen zur Verfügung, welche Produkte sich im Warenkorb befinden und welchen Gesamtwert der aktuelle Warenkorb hat.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "productIds",
    "displayName": "Produkt IDs",
    "simpleValueType": true,
    "help": "String von Produkt IDs in einem Array",
    "valueHint": "[\"A0001\",\"A0002\"]",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
  ...
  },
  {
    ...
    "valueHint": "49.99",
    "help": "Der Gesamtwert des Warenkorbs als Float-Variable"
  },
  {
    "type": "TEXT",
    "name": "voucher",
    "displayName": "Gutschein vorhanden?",
    "simpleValueType": true,
    "help": "Gibt an, ob ein Gutschein vorhanden ist (1) oder nicht (0)",
    "defaultValue": 0,
    "valueValidators": [
      {
        "type": "NON_EMPTY"
